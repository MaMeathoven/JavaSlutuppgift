...
public class GamePanel extends JPanel implements ActionListener {
    ...
    static final int UNIT_SIZE = 10; //standard 25
    static final int UNIT_REDUCTION = UNIT_SIZE/8;
    ...
    GamePanel(){
        ...
        this.setBackground(new Color(191, 201, 26)); //standard Color.black
    ...
    public void draw(Graphics g){
        ...
        g.setColor(new Color(128, 114, 4));
